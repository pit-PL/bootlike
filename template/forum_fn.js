...
function activateSubPanel(p, panels) {
	...
	for (i = 0; i < panels.length; i++) {
		...
		jQuery('#' + panels[i] + '-tab').toggleClass('active', panels[i] === showPanel);
	}
}
...
function parseDocument($container) {
	...
	* Pagination
	*/
	$container.find('.action-bar .dropdown-form :button').click(function() {
		var $input = $(this).parents('div.input-group').find('input.form-control');
		pageJump($input);
	});

	$container.find('.action-bar .dropdown-form input.form-control').on('keypress', function(event) {
	...
	$container.find('.dropdown-form').click(function() {
	...
	*/
	$container.find('#tabs, #minitabs').not('[data-skip-responsive]').each(function() {
		var $this = $(this),
			...
			$item = $ul.append('<li class="tab responsive-tab" style="display:none;"><a href="javascript:void(0);" class="responsive-tab-link">&nbsp;</a><div class="tab-dropdown" style="display: none;"><div class="pointer"><div class="pointer-inner"></div></div><ul class="dropdown-contents" /></div></li>').find('li.responsive-tab'),
